...
public class CursorTextureEditor : Editor {
    ...
    public override Texture2D RenderStaticPreview(string assetPath, Object[] subAssets, int width, int height) {
        if (Cursor.DefaultTexture != null) {
            Type t = GetType("UnityEditor.SpriteUtility");
            if (t != null) {
                MethodInfo method = t.GetMethod("RenderStaticPreview", new Type[] { typeof(Sprite), typeof(Color), typeof(int), typeof(int) });
                if (method != null) {
                    Sprite sprite = Sprite.Create(Cursor.DefaultTexture, new Rect(0, 0, Cursor.DefaultTexture.width, Cursor.DefaultTexture.height), new Vector2(Cursor.DefaultTexture.width / 2, Cursor.DefaultTexture.height / 2));
